    ...
    <div className={isDark ? "dark" : ""}>
      <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50 transition-colors duration-300">
        ...
        <main className="max-w-6xl mx-auto px-4">
            ...
            >
              <motion.div variants={fadeUp} className="space-y-5">
                ...
                <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 max-w-xl">
                  TuOrdenYa conecta menús con QR, pedidos, pagos y la operación
                  de tu restaurante en una sola plataforma. Comienza con Light y
                  sube a Plus o Pro cuando tu negocio lo necesite.
                </p>
              ...
              >
                ...
                <p className="text-xs text-slate-500">
                  *La vista es ilustrativa, pero representa el tipo de control
                  que tendrás con la versión Pro.
                </p>
              </motion.div>
            </motion.div>
          </section>
            ...
            >
              ...
              >
                <ul className="space-y-2">
                  ...
                  <li>• Recibes pedidos por WhatsApp o directamente desde el sistema.</li>
                  <li>• Actualizas precios y platos sin reimprimir menús.</li>
                </ul>
                <ul className="space-y-2">
                  <li>• Reportes básicos desde Plus y operación completa en Pro.</li>
                  <li>• Escalable: comienza con Light y migra a Plus/Pro cuando creces.</li>
                  <li>• Base lista para integrarse con tu flujo actual (POS, cocina, etc.).</li>
                </ul>
              </motion.div>
            </motion.div>
          </section>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-5 text-sm">
                ...
                >
                  ...
                  <p className="text-slate-400 text-xs">
                    Los clientes ordenan desde su celular. Tú ves pedidos,
                    tiempos y cuentas desde una vista única.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.div variants={fadeUp}>
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-400 text-xs">
                      Órdenes por franja horaria, platos más vendidos y
                      desempeño por canal.
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <ul className="space-y-2 text-xs">
                  ...
                  <li>• Negocios que ya usan POS y quieren conectar la operación.</li>
                </ul>
                <a
                  href="#contacto"
          ...
          {/* INTEGRACIONES (FUTURAS / CONECTORES) */}
          <section className="py-12">
            ...
            >
              ...
              >
                TuOrdenYa está diseñado para conversar con otras herramientas
                que ya usas en tu restaurante. Empezamos simple y vamos
                creciendo contigo.
              </motion.p>
          ...
          <section id="planes" className="py-12 border-t border-slate-800/70">
            ...
            >
              ...
              >
                Comienza con lo básico y escala a medida que tu restaurante
                crece. Todos los planes incluyen hosting, dominio técnico y
                soporte básico.
              </motion.p>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mb-3">
                      Ideal para cafeterías, food trucks y negocios pequeños
                      que quieren salir del papel.
                    </p>
              ...
              <div className="grid md:grid-cols-3 gap-5 text-xs">
                ...
                >
                  <p className="mb-3 text-slate-200">
                    “Con el menú digital y los QR dejamos de imprimir cartas
                    cada vez que subían los precios. Hoy cambiamos todo en
                    minutos.”
                  </p>
                ...
                >
                  <p className="mb-3 text-slate-200">
                    “Plus nos permitió ver qué platos se mueven más por horario
                    y tomar decisiones de menú más rápido.”
                  </p>
          ...
          <section id="faq" className="py-12 border-t border-slate-800/70">
            ...
            >
              ...
              <motion.p
                ...
                className="text-sm text-slate-400 mb-6"
              >
                Si tienes dudas específicas de tu operación, cuéntanos y
                adaptamos la implementación a tu caso.
              </motion.p>
              ...
              <motion.div variants={fadeUp} className="space-y-4 text-sm">
                ...
                <details className="group rounded-2xl border border-slate-800/70 bg-slate-900/60 px-4 py-3">
                  ...
                  <p className="mt-2 text-xs text-slate-400">
                    No necesariamente. TuOrdenYa puede convivir con tu POS
                    actual mientras definimos el nivel de integración que tenga
                ...
                <details className="group rounded-2xl border border-slate-800/70 bg-slate-900/60 px-4 py-3">
                  ...
                  <p className="mt-2 text-xs text-slate-400">
                    Sí. Justamente la idea es que empieces con lo básico y
                    puedas migrar a Plus o Pro cuando el volumen de tu
                    restaurante lo justifique.
                  </p>
                </details>
              </motion.div>
            </motion.div>
            ...
            >
              <motion.div variants={fadeUp}>
                ...
                <p className="text-sm text-slate-400 mb-4">
                  ...
                  TuOrdenYa puede ayudarte a vender más y operar mejor.
                </p>
              ...
              >
                ...
                {/* Aquí luego conectas al backend / Supabase / Formspree, etc. */}
                <button
                  type="button"
